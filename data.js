...
export const CONTACT_EMAIL = "power77aa@gmail.com"; // 내부용 · 화면에는 절대 직접 노출하지 않음 (문의 폼으로만 전달)
export const CONTACT_FORM_ENDPOINT = "https://formspree.io/f/mrpzvvbj";
export const SITE_URL = "https://mommilliliter.vercel.app"; // 실제 배포 주소 · 도메인 연결 시 이 값도 함께 교체
...
export const POLICIES = {
  privacy: {
    ...
    body: [
      ...
      "4. 문의처: 개인정보 관련 문의는 문의하기 페이지의 폼을 통해 연락해 주세요.",
    ],
  },
  terms: {
    title: "이용약관",
